...
if [ "$LOADER_TYPE" = "fabric" ]; then
  ...
  FABRIC_API_VERSION=$(grep "^fabricapi_version=" ../../../gradle.properties | cut -d'=' -f2)
  ...
  CLOTHCONFIG_URL="https://maven.shedaniel.me/me/shedaniel/cloth/cloth-config-neoforge/${CLOTHCONFIG_VERSION}/cloth-config-neoforge-${CLOTHCONFIG_VERSION}.jar"
