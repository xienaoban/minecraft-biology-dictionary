...
public final class Permissions {
    public static void checkPlayerCreativeMode(Player player) {
    ...
    public static void checkPlayerExperience(Player player, int experience) {
        int exp = PlayerUtils.getExperience(player);
        if (exp >= experience) { return; }
        throw new NoPermissionException(Component.translatable(Lang.TEXT_NOT_ENOUGH_EXPERIENCE), "No enough experience: " + exp + " < " + experience);
    }
