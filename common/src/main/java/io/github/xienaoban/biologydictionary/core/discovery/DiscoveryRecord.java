...
public record DiscoveryRecord(
    ...
    private static final ResourceLocation NO_ID = new ResourceLocation("unknown");
    ...
    public static DiscoveryRecord discoveredNow(long gameTick, Entity entity, DiscoverySource source) {
        ...
        return new DiscoveryRecord(
            ...
            level.getBiome(pos).unwrapKey().map(net.minecraft.resources.ResourceKey::location).orElse(NO_ID),
            pos,
