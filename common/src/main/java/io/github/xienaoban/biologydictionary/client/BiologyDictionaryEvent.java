...
public final class BiologyDictionaryEvent {
    public static void openBookScreen(Minecraft client) {
        ...
        try {
            ...
            if (hasPermissionToOpenBook(player)) {
                ...
                ClientUtils.sendCenteredMessage(TextUtils.translate(Lang.TEXT_NO_BIOLOGY_DICTIONARY_BOOK)
    ...
    private static void openBookScreen0(Minecraft client, LocalPlayer player) {
        ...
        if (y < -0.996F * 90.0F) {
            ...
            BiologyDictionaryClient.setHitBlock(pos);
        ...
        if (entry == null) {
            ...
            BiologyDictionaryClient.setHitEntity(target);
