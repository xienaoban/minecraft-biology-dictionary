...
public final class Textures {
    ...
    public static final ResourceLocation BOOK_TOOLTIP_BACKGROUND = IdentifierUtils.bd("textures/gui/sprites/tooltip/book_tooltip_background.png");
    public static final ResourceLocation BOOK_TOOLTIP_FRAME = IdentifierUtils.bd("textures/gui/sprites/tooltip/book_tooltip_frame.png");
}
