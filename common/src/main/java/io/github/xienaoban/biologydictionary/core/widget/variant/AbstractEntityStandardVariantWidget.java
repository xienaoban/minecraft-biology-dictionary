...
public abstract class AbstractEntityStandardVariantWidget<E extends Entity, V>
    ...
    protected static <E extends Entity> int getVariantCount(EntityProperties<E> properties, int variantHandlerIdx) {
        return getVariantHandler(properties.entity(), variantHandlerIdx).getVariants(properties.entity()).size();
    }
    ...
    protected Component getVariantName(V variant) {
        String name = getVariantHandler(e(), getVariantHandlerIdx()).getVariantName(e(), variant);
