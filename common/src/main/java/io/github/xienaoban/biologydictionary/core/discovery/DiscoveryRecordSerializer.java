...
public final class DiscoveryRecordSerializer {
    ...
    public static final Codec<DiscoveryRecord> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("dimension", DiscoveryRecord.NO_ID).forGetter(DiscoveryRecord::dimension),
            Identifier.CODEC.optionalFieldOf("biome", DiscoveryRecord.NO_ID).forGetter(DiscoveryRecord::biome),
    ...
    public static DiscoveryRecord readFromBuf(FriendlyByteBuf buf) {
        ...
        Identifier dimension = dimStr.isEmpty() ? DiscoveryRecord.NO_ID : Identifier.tryParse(dimStr);
