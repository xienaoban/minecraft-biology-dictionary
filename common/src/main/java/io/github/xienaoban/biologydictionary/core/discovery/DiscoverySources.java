...
public final class DiscoverySources {
    ...
    private static final Map<ResourceLocation, DiscoverySource> REGISTRY = new LinkedHashMap<>();
    ...
    private static ResourceLocation id(String path) {
        return ResourceLocation.fromNamespaceAndPath(BiologyDictionary.MOD_ID, path);
    }
