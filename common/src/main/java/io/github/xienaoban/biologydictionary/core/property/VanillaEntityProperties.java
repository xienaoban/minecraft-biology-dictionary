...
import io.github.xienaoban.biologydictionary.core.property.vanilla.ItemStackProperty;
import io.github.xienaoban.biologydictionary.core.property.vanilla.MobEffectInstanceListProperty;
...
public class VanillaEntityProperties {
    ...
    public static final class OfLivingEntity implements Creator {
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createAbsorptionAmountProperty(), createActiveEffectsProperty(), createAttributesProperty(), createBrainProperty(), createDeathTimeProperty(), createFallFlyingProperty(), createHealthProperty(), createHurtByTimestampProperty(), createHurtTimeProperty(), createSleepingXProperty(), createSleepingYProperty(), createSleepingZProperty(), createTeamProperty());
        }
    }
    ...
    public static final class OfMob implements Creator {
        ...
        public static UnsupportedProperty<Mob> getHandItemsProperty(EntityProperties<?> ep) {
            return g(ep, "HandItems");
        }

        public static UnsupportedProperty<Mob> createLeashProperty() {
            return new UnsupportedProperty<>("Leash");
        }

        public static UnsupportedProperty<Mob> getLeashProperty(EntityProperties<?> ep) {
            return g(ep, "Leash");
        }
    ...
    public static final class OfTamableAnimal implements Creator {
        ...
        public static UuidProperty<TamableAnimal> createOwnerProperty() {
            return new UuidProperty<>("Owner");
        }

        public static UuidProperty<TamableAnimal> getOwnerProperty(EntityProperties<?> ep) {
            return g(ep, "Owner");
        }
    ...
    public static final class OfWolf implements Creator {
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createCollarColorProperty());
        }
    }
     ...
     * [Attention] Some properties cannot be recognized yet:
     *  - "FlowerPos": [COMPOUND, BLOCK_POS]
     *  - "HivePos": [COMPOUND, BLOCK_POS]
     *
    ...
    public static final class OfBee implements Creator {
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createCannotEnterHiveTicksProperty(), createCropsGrownSincePollinationProperty(), createFlowerPosProperty(), createHasNectarProperty(), createHasStungProperty(), createHivePosProperty(), createTicksSincePollinationProperty());
        }
    }
    ...
    public static final class OfMushroomCow implements Creator {
        ...
        public static IntProperty<MushroomCow> createEffectDurationProperty() {
            return new IntProperty<>("EffectDuration");
        }

        public static IntProperty<MushroomCow> getEffectDurationProperty(EntityProperties<?> ep) {
            return g(ep, "EffectDuration");
        }

        public static IntProperty<MushroomCow> createEffectIdProperty() {
            return new IntProperty<>("EffectId");
        }

        public static IntProperty<MushroomCow> getEffectIdProperty(EntityProperties<?> ep) {
            return g(ep, "EffectId");
        }
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createEffectDurationProperty(), createEffectIdProperty(), createTypeProperty());
        }
    }
    ...
    public static final class OfAbstractHorse implements Creator {
        ...
        public static UuidProperty<AbstractHorse> createOwnerProperty() {
            return new UuidProperty<>("Owner");
        }

        public static UuidProperty<AbstractHorse> getOwnerProperty(EntityProperties<?> ep) {
            return g(ep, "Owner");
        }
    ...
    public static final class OfLlama implements Creator {
        ...
        public static UnsupportedProperty<Llama> createDecorItemProperty() {
            return new UnsupportedProperty<>("DecorItem");
        }

        public static UnsupportedProperty<Llama> getDecorItemProperty(EntityProperties<?> ep) {
            return g(ep, "DecorItem");
        }
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createDecorItemProperty(), createStrengthProperty(), createVariantProperty());
        }
    }
    ...
    public static final class OfHorse implements Creator {
        ...
        public static UnsupportedProperty<Horse> createArmorItemProperty() {
            return new UnsupportedProperty<>("ArmorItem");
        }

        public static UnsupportedProperty<Horse> getArmorItemProperty(EntityProperties<?> ep) {
            return g(ep, "ArmorItem");
        }
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createArmorItemProperty(), createVariantProperty());
        }
    }
    ...
    public static final class OfVillager implements Creator {
        ...
        public static UnsupportedProperty<Villager> createOffersProperty() {
            return new UnsupportedProperty<>("Offers");
        }

        public static UnsupportedProperty<Villager> getOffersProperty(EntityProperties<?> ep) {
            return g(ep, "Offers");
        }
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createAssignProfessionWhenSpawnedProperty(), createFoodLevelProperty(), createGossipsProperty(), createLastGossipDecayProperty(), createLastRestockProperty(), createOffersProperty(), createRestocksTodayProperty(), createVillagerDataProperty(), createXpProperty());
        }
    }
     ...
     *  - "DespawnDelay": INT
     * [Attention] Some properties cannot be recognized yet:
     *  - "WanderTarget": [COMPOUND, BLOCK_POS]
     *
    ...
    public static final class OfAllay implements Creator {
        ...
        public static UnsupportedProperty<Allay> createPotionProperty() {
            return new UnsupportedProperty<>("Potion");
        }

        public static UnsupportedProperty<Allay> getPotionProperty(EntityProperties<?> ep) {
            return g(ep, "Potion");
        }
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createCanDuplicateProperty(), createDuplicationCooldownProperty(), createPotionProperty(), createListenerProperty());
        }
    }
     ...
     *  - "Patrolling": BOOLEAN
     * [Attention] Some properties cannot be recognized yet:
     *  - "PatrolTarget": [COMPOUND, BLOCK_POS]
     *
    ...
    public static final class OfPatrollingMonster implements Creator {
        ...
        @Override
        public void create(Map<String, EntityProperty<?>> map) {
            p(map, createPatrolLeaderProperty(), createPatrolTargetProperty(), createPatrollingProperty());
        }
    }
