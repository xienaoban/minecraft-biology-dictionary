...
public abstract class AbstractLivingEntityAttributeWidget<E extends LivingEntity> extends EntityPropertyStandardWidget<E> {
    ...
    protected void onRender(ScreenRenderingContext ctx) {
        ...
        String showCurr = StringUtils.format3Digits(BiologyDictionaryClient.isDebugMode() ? currAttr : currValue);
        String showUnit = BiologyDictionaryClient.isDebugMode() ? "value" : calcUnit(currAttr, currValue);
