...
public final class SilhouetteMultiBufferSource implements MultiBufferSource {
    ...
    private static final VertexConsumer NOOP = new VertexConsumer() {
        ...
        @Override public void vertex(float x, float y, float z, float r, float g, float b, float a, float u, float v, int overlay, int light, float normalX, float normalY, float normalZ) {}
     ...
     */
    private static final MultiBufferSource.BufferSource outlineBuffer = MultiBufferSource.immediate(new BufferBuilder(1536));
     ...
     */
    private static class ColorOverrideConsumer extends DefaultedVertexConsumer {
        ...
        public void defaultColor(int r, int g, int b, int a) {
            // No-op: the silhouette color is set in the constructor.
        }
        ...
        /** No-op: the silhouette color is set via defaultColor, not here. */
        @Override
        ...
        @Override
        public void vertex(float x, float y, float z, float r, float g, float b, float a, float u, float v, int overlay, int light, float normalX, float normalY, float normalZ) {
