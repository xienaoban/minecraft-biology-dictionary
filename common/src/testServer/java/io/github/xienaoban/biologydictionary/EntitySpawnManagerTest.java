...
public class EntitySpawnManagerTest {
    ...
    public void testGuardianSpawnsInOceanMonument(GameTestHelper helper) {
        ...
        helper.assertTrue(structures.contains(new ResourceLocation("minecraft", "monument")),
    ...
    public void testWardenSpawnsInAncientCity(GameTestHelper helper) {
        ...
        helper.assertTrue(structures.contains(new ResourceLocation("minecraft", "ancient_city")),
    ...
    public void testEnderDragonSpawnsInTheEnd(GameTestHelper helper) {
        ...
        helper.assertTrue(biomes.contains(new ResourceLocation("minecraft", "the_end")),
    ...
    public void testVexSpawnsInMansion(GameTestHelper helper) {
        ...
        helper.assertTrue(structures.contains(new ResourceLocation("minecraft", "mansion")),
    ...
    public void testCaveSpiderSpawnsInMineshaft(GameTestHelper helper) {
        ...
        helper.assertTrue(structures.contains(new ResourceLocation("minecraft", "mineshaft")),
    ...
    public void testBeeSpawnsInFlowerForest(GameTestHelper helper) {
        ...
        helper.assertTrue(biomes.contains(new ResourceLocation("minecraft", "flower_forest")),
    ...
    public void testOceanMonumentHasGuardians(GameTestHelper helper) {
        EntitySpawnManager manager = getManager(helper);
        if (manager == null) return;
        Set<EntityType<?>> entities = manager.getStructureEntities(new ResourceLocation("minecraft", "monument"));
    ...
    public void testPlainsHasChicken(GameTestHelper helper) {
        EntitySpawnManager manager = getManager(helper);
        if (manager == null) return;
        Set<EntityType<?>> entities = manager.getBiomeEntities(new ResourceLocation("minecraft", "plains"));
    ...
    public void testAncientCityHasWarden(GameTestHelper helper) {
        EntitySpawnManager manager = getManager(helper);
        if (manager == null) return;
        Set<EntityType<?>> entities = manager.getStructureEntities(new ResourceLocation("minecraft", "ancient_city"));
    ...
    public void testFlowerForestHasBee(GameTestHelper helper) {
        EntitySpawnManager manager = getManager(helper);
        if (manager == null) return;
        Set<EntityType<?>> entities = manager.getBiomeEntities(new ResourceLocation("minecraft", "flower_forest"));
    ...
    public void testCatSpawnsOnlyInVillagesAndWitchHut(GameTestHelper helper) {
        ...
        helper.assertTrue(structures.contains(new ResourceLocation("minecraft", "swamp_hut")),
    ...
    public void testParrotSpawnsOnlyInJungleAndBambooJungle(GameTestHelper helper) {
        ...
        helper.assertTrue(biomes.contains(new ResourceLocation("minecraft", "jungle")),
            "Parrot should spawn in jungle");
        helper.assertTrue(biomes.contains(new ResourceLocation("minecraft", "bamboo_jungle")),
