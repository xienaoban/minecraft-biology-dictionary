package io.github.xienaoban.biologydictionary.platform.neoforge;
...
public final class PluginLookupImpl {
    public static PluginLookup.Bridge getBridge() {
        return new Bridge();
    }

    private static final class Bridge implements PluginLookup.Bridge {
        @Override
